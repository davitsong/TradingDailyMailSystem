...
def generate_report():
    ...
    if hour < 12:
        ...
        # 💡 프롬프트 보강: 분석 날짜 주입 및 기업명 출력 강제 규칙 추가
        prompt = f"""
        ...
        3. 오늘 밤 주목해야 할 미국 주식 3개를 추천하되, 반드시 해당 기업의 '공식 이름(종목명)'과 '티커(예: AAPL, TSLA)'를 제목에 명확히 표기하고 구체적인 이유와 근거를 제시해줘. 두루뭉술하게 업종명으로만 적으면 안 돼.
